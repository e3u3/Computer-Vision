...
\hypertarget{piazza-gradescope-and-python}{%
...
introduction to Numpy and some other libraries.
    ...
    \hypertarget{getting-started-with-numpy}{%
...
[[3. 5. 0.]
 [5. 0. 0.]]
    ...
    \hypertarget{operations-on-array}{%
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}        \PY{c+c1}{\PYZsh{} sum of each column need a row result}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}        \PY{c+c1}{\PYZsh{} sum of each row need a column result}
...
this assignment.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} this line prepares IPython for working with matplotlib}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}x and y value}
...
\begin{center}\rule{0.5\linewidth}{\linethickness}\end{center}
    ...
    \hypertarget{problem-1-image-operations-and-vectorization-1pt}{%
...
Image shape (512, 512, 3)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{iterative}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} The code for this problem is posted on Piazza. Sign up for the course if you have not. Then find}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Iterative method took 0.7529640197753906 seconds
Vectorized method took 0.003984212875366211 seconds

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} Plotting the results in sepearate subplots}
...
\end{Verbatim}
    ...
    \hypertarget{problem-2-further-image-manipulation-5pts}{%
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Write your code here. Import the image and define the required funtions.}
         ...
         \PY{k}{def} \PY{n+nf}{getChannel}\PY{p}{(}\PY{n}{img}\PY{p}{,}\PY{n}{channel}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{return} \PY{n}{image}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,} \PY{n}{channel} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
         ...
         \PY{k}{def} \PY{n+nf}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,}\PY{n}{image2}\PY{p}{,}\PY{n}{image3}\PY{p}{)}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{} Write your code here}
             \PY{c+c1}{\PYZsh{} input 2d matrix }
             \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{dstack}\PY{p}{(}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{n}{image2}\PY{p}{,} \PY{n}{image3}\PY{p}{)}\PY{p}{)}
             \PY{c+c1}{\PYZsh{} np.dstack()}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} Test your function}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Write your code here for tiling the six images to make a single image and displaying it. }
         ...
         \PY{n}{red\PYZus{}channel} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{green\PYZus{}channel} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
         \PY{n}{blue\PYZus{}channel} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}
         \PY{n}{zero\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros\PYZus{}like}\PY{p}{(}\PY{n}{blue\PYZus{}channel}\PY{p}{)}
         
         
         \PY{n}{RGB\PYZus{}img} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{red\PYZus{}channel}\PY{p}{,} \PY{n}{green\PYZus{}channel}\PY{p}{,} \PY{n}{blue\PYZus{}channel}\PY{p}{)}
         \PY{n}{red\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{red\PYZus{}channel}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
         \PY{n}{green\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{green\PYZus{}channel}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
         \PY{n}{blue\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{blue\PYZus{}channel}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
         \PY{n}{BGR\PYZus{}img} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{blue\PYZus{}channel}\PY{p}{,} \PY{n}{green\PYZus{}channel}\PY{p}{,} \PY{n}{red\PYZus{}channel}\PY{p}{)}
         
         \PY{n}{horizontal\PYZus{}img1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{red\PYZus{}img}\PY{p}{,} \PY{n}{green\PYZus{}img}\PY{p}{)}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{horizontal\PYZus{}img2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{blue\PYZus{}img}\PY{p}{,} \PY{n}{RGB\PYZus{}img}\PY{p}{,} \PY{n}{BGR\PYZus{}img}\PY{p}{)}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
         
         \PY{n}{result\PYZus{}img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{horizontal\PYZus{}img1}\PY{p}{,} \PY{n}{horizontal\PYZus{}img2}\PY{p}{)}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{result\PYZus{}img}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
